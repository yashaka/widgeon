...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Yet another page objects for Capybara of 2.0.3 version, i.e. compatible with ruby 1.8.7. Support for latest versions will be added soon}
